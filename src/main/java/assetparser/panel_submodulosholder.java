...
public class panel_submodulosholder extends javax.swing.JPanel {
	/*
	 * classe que segura os subitens do analisador de asset, ateh o momento estes
	 * itens sao grafico (para analise tecnica) trader, traderbot e interface para
	 * trades offlines
	 */
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1164760293383132882L;
	...
	public assetparser.panel_analisadorasset assetpai;
	// submobulo grafico
	public assetparser.submodulografico.panel_submodulografico subgrafico;
	// submodulo trader
	public assetparser.submoduloofflinetrader.panel_submoduloofflinetrader subtrader;
	// recebe o simbolo deste asset
	public String assetsimbolo;
	// </editor-fold>

	// <editor-fold defaultstate="collapsed" desc="CONSTRUTOR">
	public panel_submodulosholder(assetparser.panel_analisadorasset aapai) throws IOException {
		initComponents();
	...
	// <editor-fold defaultstate="collapsed" desc="Inicialização, Atualização do
	// Asset e Timer">
	void inicializar(assetparser.panel_analisadorasset aapai) throws IOException {
		...
		subgrafico = new assetparser.submodulografico.panel_submodulografico(this);
		subtrader = new assetparser.submoduloofflinetrader.panel_submoduloofflinetrader(this);
	...
	void setartimeratualizacao() throws IOException {
	...
	public void atualizardadosasset() throws IOException {
	...
	// <editor-fold defaultstate="collapsed" desc="Salvar e Carregar Dados do
	// Asset">
	...
	public void salvardadosasset() {
		...
		try {
			...
			for (int i = 0; i < subgrafico.jPanelIndicadores.getComponentCount(); i++) {
				assetparser.submodulografico.panel_itemindicador miia = (assetparser.submodulografico.panel_itemindicador) subgrafico.jPanelIndicadores
						.getComponent(i);
				subxmlIndicadores = subxmlIndicadores + "<Indicator>" + "<Name>"
						+ miia.jLabelNomeItemIndicador.getText() + "</Name>" + "<ID>" + miia.id + "</ID>" + "<BCID>"
						+ miia.mcbcindicador.idbcode + "</BCID>" + "<Parameters>" + miia.mcbcindicador.parametrosbcodejs
			...
			for (int i = 0; i < subgrafico.jPanelAnotacoes.getComponentCount(); i++) {
				assetparser.submodulografico.panel_itemanotacao miaa = (assetparser.submodulografico.panel_itemanotacao) subgrafico.jPanelAnotacoes
						.getComponent(i);
				...
				subxmlAnotacoes = subxmlAnotacoes + "<Annotation>" + "<Name>" + miaa.jLabelNomeItemAnotacao.getText()
						+ "</Name>" + "<ID>" + miaa.id + "</ID>" + "<Type>" + miaa.tipoanotacao + "</Type>"
						+ "<Parameters>" + anotacaoserializada + "</Parameters>" + "</Annotation>";
			}
			// </editor-fold>

			String subxmlChart =

					"<CMainInfo>" + "<Symbol>" + subgrafico.jTextFieldNomeSimbolo.getText() + "</Symbol>" + "<Scale>"
							+ subgrafico.escalagraficoescolhido + "</Scale>" + "<Period>"
							+ subgrafico.jComboBoxPeriodoSimbolo.getSelectedItem().toString() + "</Period>"
							+ "</CMainInfo>" +

							"<IndicatorsInfo>" + subxmlIndicadores + "</IndicatorsInfo>" +

							"<AnnotationsInfo>" + subxmlAnotacoes + "</AnnotationsInfo>";
			...
			for (int i = 0; i < subtrader.otrader.transacoes.size(); i++) {
				communication.mcofflinetransaction transacaoatual = subtrader.otrader.transacoes.get(i);

				subxmlTransacoes = subxmlTransacoes + "<Transaction>" + "<ID>" + transacaoatual.idstr + "</ID>"
						+ "<TypeTransaction>" + transacaoatual.tipostr + "</TypeTransaction>" + "<PriceTransaction>"
						+ transacaoatual.preco_tradestr + "</PriceTransaction>" + "<AmountTransaction>"
						+ transacaoatual.quantidadestr + "</AmountTransaction>" + "<TimestamplongTransaction>"
						+ transacaoatual.timestampstr + "</TimestamplongTransaction>" + "</Transaction>";
			}

			String subxmlTrader =

					"<TOMainInfo>" + "<Symbol>" + subtrader.otrader.simbolo + "</Symbol>" + "<BaseCurrencyAmount>"
							+ String.valueOf(subtrader.otrader.quantidademoedabase) + "</BaseCurrencyAmount>"
							+ "<QuoteCurrencyAmount>" + String.valueOf(subtrader.otrader.quantidademoedacotacao)
							+ "</QuoteCurrencyAmount>" + "</TOMainInfo>" +

							"<TransactionsInfo>" + subxmlTransacoes + "</TransactionsInfo>";

			// </editor-fold>

			String xmlSave = "<?xml version=\"1.0\"?>" + "<OpenstockAssetSave>" +

					"<About>" + "<Name>"
					+ subgrafico.submodulohpai.assetpai.iaassetpai.jLabelNomeAnalisadorAsset.getText() + "</Name>"
					+ "<ID>" + subgrafico.submodulohpai.assetpai.iaassetpai.id + "</ID>" + "</About>" +

					"<Chart>" + subxmlChart + "</Chart>" +

					"<TraderOffline>" + subxmlTrader + "</TraderOffline>" +
			...
			if (userSelection == javax.swing.JFileChooser.APPROVE_OPTION) {
				...
				writer.close();
				communication.mcfuncoeshelper.mostrarmensagem("Asset file saved.");
			}
	...
	public void carregardadosasset() {
		try {
			...
			if (userSelection == javax.swing.JFileChooser.APPROVE_OPTION) {
				...
				// <editor-fold defaultstate="collapsed" desc="comecar recarregando o submodulo
				// com o nome e simbolo desejado">
				...
				for (int i = 0; i < listaindicadores.getLength(); i++) {
					...
					String parametrosbc_indicador = elindicador.getElementsByTagName("Parameters").item(0)
							.getTextContent();

					// public itemindicador(mierpanels.submodulografico mpsmg, String idind, String
					// nome, String idbearcode, String parametrosbearcode)
					subgrafico.adicionarIndicadorLoad(nome_indicador, id_indicador, bcid_indicador,
							parametrosbc_indicador);
				}
				...
				for (int i = 0; i < listaanotacoes.getLength(); i++) {
					...
					subgrafico.adicionarAnotacaoLoad(nome_anotacao, id_anotacao, tipo_anotacao,
							listasubanotacoesdaanotacao);
				}
				...
				String quantidademoedabase = elotradermaininfounico.getElementsByTagName("BaseCurrencyAmount").item(0)
						.getTextContent();
				String quantidademoedacotacao = elotradermaininfounico.getElementsByTagName("QuoteCurrencyAmount")
				...
				for (int i = 0; i < listatransacoes.getLength(); i++) {
					...
					String tipo_transacao = eltransacao.getElementsByTagName("TypeTransaction").item(0)
							.getTextContent();
					String preco_transacao = eltransacao.getElementsByTagName("PriceTransaction").item(0)
							.getTextContent();
					String quantidade_transacao = eltransacao.getElementsByTagName("AmountTransaction").item(0)
							.getTextContent();
					String timestamplongstr_transacao = eltransacao.getElementsByTagName("TimestamplongTransaction")
							.item(0).getTextContent();
					...
					communication.mcofflinetransaction mcotransacaoadicionar = new communication.mcofflinetransaction(
							id_transacao, tipo_transacao, preco_transacao, quantidade_transacao,
							timestamplongstr_transacao);
	...
	private void initComponents() {
		...
		jPanelSubmodulosHolderLayout.setHorizontalGroup(jPanelSubmodulosHolderLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 0, Short.MAX_VALUE));
		jPanelSubmodulosHolderLayout.setVerticalGroup(jPanelSubmodulosHolderLayout
		...
		jComboBoxTempoAtualizacao.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Off", "1 minute",
				"5 minutes", "15 minutes", "30 minutes", "1 hour", "3 hours", "6 hours", "12 hours", "1 day", "2 days",
				"5 days", "15 days", "1 month", "3 months", "6 months" }));
		...
		jLabelDetachSubmodulosholder
				.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/detachicon.png"))); // NOI18N
		...
		jPanelEscolherSubmoduloLayout.setHorizontalGroup(
				jPanelEscolherSubmoduloLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addComponent(jPanelSubmodulosHolder, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addGroup(jPanelEscolherSubmoduloLayout.createSequentialGroup().addContainerGap()
								.addGroup(jPanelEscolherSubmoduloLayout
										...
										.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
												jPanelEscolherSubmoduloLayout.createSequentialGroup()
														.addComponent(jLabelUltimaAtualizacao)
														.addPreferredGap(
																javax.swing.LayoutStyle.ComponentPlacement.RELATED, 196,
																Short.MAX_VALUE)
														...
														.addPreferredGap(
																javax.swing.LayoutStyle.ComponentPlacement.RELATED)
														.addComponent(jComboBoxTempoAtualizacao,
																javax.swing.GroupLayout.PREFERRED_SIZE, 150,
																javax.swing.GroupLayout.PREFERRED_SIZE)))
								.addContainerGap()));
		jPanelEscolherSubmoduloLayout.setVerticalGroup(jPanelEscolherSubmoduloLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelEscolherSubmoduloLayout
						.createSequentialGroup().addContainerGap()
						.addGroup(jPanelEscolherSubmoduloLayout
								.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(jPanelEscolherSubmoduloLayout
										.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
										.addComponent(jButtonMostrarTrader, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addComponent(jButtonMostrarGrafico))
								.addComponent(jLabelDetachSubmodulosholder))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						...
						.addGroup(jPanelEscolherSubmoduloLayout
								...
								.addGroup(jPanelEscolherSubmoduloLayout
										...
										.addComponent(jComboBoxTempoAtualizacao, javax.swing.GroupLayout.PREFERRED_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addComponent(jLabelTempoAtualizacao))
								.addComponent(jLabelTimer).addComponent(jLabelUltimaAtualizacao))
						.addContainerGap()));
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				...
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(
						jPanelEscolherSubmodulo, javax.swing.GroupLayout.Alignment.TRAILING,
						javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		layout.setVerticalGroup(
				layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 428, Short.MAX_VALUE)
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(
								jPanelEscolherSubmodulo, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
	...
	private void jComboBoxTempoAtualizacaoActionPerformed(java.awt.event.ActionEvent evt) throws IOException// GEN-FIRST:event_jComboBoxTempoAtualizacaoActionPerformed
