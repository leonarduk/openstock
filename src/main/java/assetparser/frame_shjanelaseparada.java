...
public class frame_shjanelaseparada extends javax.swing.JFrame
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1697985135677054438L;
	//classe frame utilizada para segurar o submodulosholder em uma janela separada
    static assetparser.panel_analisadorasset aassetpai;

    /**
     * Creates new form analisadorassetjanelaholder
     */
    public frame_shjanelaseparada(assetparser.panel_analisadorasset aapai)
    {
        initComponents();
