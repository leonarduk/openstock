...
public class panel_itemtransacao extends javax.swing.JPanel
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1034738915485301283L;
	//submodulo grafico ao qual este item anotacao pertence
    public communication.mcofflinetransaction offlinetransactionassociada;
    
    //construtor nova anotacao
    public panel_itemtransacao(communication.mcofflinetransaction otransaction)
    {
        initComponents();
    ...
    {//GEN-HEADEREND:event_jLabelIDMousePressed
        communication.mcfuncoeshelper.setarclipboard(jLabelID.getText());
        communication.mcfuncoeshelper.mostrarmensagem("Transaction ID copied to clipboard.");
