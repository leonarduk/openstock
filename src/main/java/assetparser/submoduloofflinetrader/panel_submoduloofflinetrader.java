...
public class panel_submoduloofflinetrader extends javax.swing.JPanel {
	/*
	 * submodulo offline trader, utilizado para manual trading tests e algotrading
	 * tests
	 */
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8295665563101944447L;
	...
	// classe interpretadora de bearcode (contem o codigo relacionado ao bot trader
	// em uso)
	public communication.mcbctradingbotinterpreter mcbctradingbot;
	// </editor-fold>

	// <editor-fold defaultstate="collapsed" desc="CONSTRUTOR">
	public panel_submoduloofflinetrader(assetparser.panel_submodulosholder shpai) {
		initComponents();

		submodulohpai = shpai;
		otrader = new communication.mcofflinetrader(this);
	...
	void inicializarsubmoduloofflinetrader() {
		...
		// ativar ou desativar checkbox do telegram se a funcionalidade estiver
		// disponivel ou nao
		...
		for (int i = 0; i < otrader.transacoes.size(); i++) {
			jPanelLinhasTransacoes
					.add(new assetparser.submoduloofflinetrader.panel_itemtransacao(otrader.transacoes.get(i)));
		}
	...
	public void recarregardadossubmoduloofflinetrader() {
		// caso o simbolo tenha sido alterado, as informacoes do trader precisam ser
		// resetadas
	...
	// <editor-fold defaultstate="collapsed" desc="Implementação para Realização
	// de Transações Manuais">
	public String realizardepositoousaque(String tipomoeda, String depositoousaque, String valortransacao) {
		try {
			...
			if (resposta.equals("ok") == true) {
				// considerando que a transacao foi bem sucedida, recarregar submodulo para
				// mostrar nova linha de transacao
		...
		try {
			...
			if (resposta.equals("ok") == true) {
				...
				if (mostrarmensagem == true)
					communication.mcfuncoeshelper.mostrarmensagem(resposta);
			}
		} catch (Exception ex) {
			// caso aja algum problema, ignorar todo o processo de transacao
			if (mostrarmensagem == true)
				communication.mcfuncoeshelper.mostrarmensagem("erro - " + ex.getMessage());
		}
	}
...
//					String caminhobcode = elIndicador.getElementsByTagName("BearcodeFile").item(0).getTextContent();
	...
	void repopularbearcodetraderbot(String idbearcode, String parametrosbearcode) {
		// funcao para popular mcbctradingbotinterpreter beacode trader bot engine
		// utilizado por este submodulo

		// public mcbcindicatorinterpreter(String tipo, String id, String nome, String
		// codbcjs, String paramsbcjs)
		// funcao para criar um novo mcbcindicatorinterpreter, que sera utilizado para
		// interpretar o codigo bearcode e gerar os valores x e y relacionados a este
		// indicador
		...
		// <editor-fold defaultstate="collapsed" desc="encontrar caminho e nome deste
		...
		try {
			...
			e.printStackTrace();
			communication.mcfuncoeshelper.mostrarmensagem("Uma exceção ocorreu: " + e.getLocalizedMessage());
		}
		// </editor-fold>
		...
		try {
			...
			// mierclasses.mcfuncoeshelper.mostrarmensagem("conteudoscriptbci: " +
			// conteudoscriptbci);
		} catch (Exception e) {
			e.printStackTrace();
			communication.mcfuncoeshelper.mostrarmensagem("Uma exceção ocorreu: " + e.toString());
		...
		mcbctradingbot = new communication.mcbctradingbotinterpreter(idbci, nomebci, conteudoscriptbci,
				parametrosbearcode);
	}
	...
	java.util.List<communication.mccandle> candlesrunanterior;
	...
	void rodartraderbot() {
		...
		if (botativado == true) {
			java.util.List<communication.mccandle> candlesusar = submodulohpai.subgrafico.mcg.mcg_candles;

			if (candlesusar != candlesrunanterior) {
				candlesrunanterior = candlesusar;

				String statusrodarscript = mcbctradingbot.rodarscript(candlesrunanterior, otrader.quantidademoedabase,
						otrader.quantidademoedacotacao, otrader.melhorbid, otrader.melhorask, otrader.feecompra,
						otrader.feevenda, false, null);
				...
				if (statusrodarscript.equals("ok") == true) {
					...
					if (traderbot_move.equals("hold")) {
						...
						jLabelTraderbot.setText(
								"Trader Bot Controller (last decision: BUY AMOUNT " + traderbot_supportamount + ")");
						...
						jLabelTraderbot.setText(
								"Trader Bot Controller (last decision: SELL AMOUNT " + traderbot_supportamount + ")");
					}

					// verificar envio de comunicacao via telegram
					// uma mensagem sera enviada via telegram caso a nova move seja diferente da
					// move anterior
					if ((traderbot_moveanterior.equals(traderbot_move) == false)
							&& (jCheckBoxSendTelegram.isSelected() == true)) {
						String mensagemenviar = submodulohpai.assetpai.iaassetpai.jLabelNomeAnalisadorAsset.getText()
								+ " (" + submodulohpai.assetsimbolo + "): " + "[" + traderbot_move.toUpperCase() + " "
								+ traderbot_supportamount + "]" + " Current Base: "
								+ String.valueOf(otrader.quantidademoedabase) + " Current Quote: "
								+ String.valueOf(otrader.quantidademoedacotacao) + " Total: "
								+ String.valueOf(otrader.totalfundos_moedacotacao());

						submodulohpai.assetpai.iaassetpai.tprincipalpai.mstelegramcomms
								.enviarmensagemtelegramcombot(mensagemenviar);
					}
	...
	private void initComponents() {
		...
		jTextFieldComprarQuantidade.setHorizontalAlignment(SwingConstants.RIGHT);
		...
		jTextFieldComprarTotal.setHorizontalAlignment(SwingConstants.RIGHT);
		...
		jPanelSubComprarLayout.setHorizontalGroup(
				jPanelSubComprarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(
						jLabelComprar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE,
						javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE));
		jPanelSubComprarLayout
				.setVerticalGroup(jPanelSubComprarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addComponent(jLabelComprar, javax.swing.GroupLayout.Alignment.TRAILING,
		...
		jTextFieldMelhorAsk.setHorizontalAlignment(SwingConstants.RIGHT);
		...
		jPanelCompraManualLayout.setHorizontalGroup(
				jPanelCompraManualLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addComponent(jPanelSubComprar, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addGroup(jPanelCompraManualLayout.createSequentialGroup().addContainerGap()
								.addGroup(jPanelCompraManualLayout
										.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addGroup(jPanelCompraManualLayout.createSequentialGroup()
												.addComponent(jLabelFeeCompra, javax.swing.GroupLayout.PREFERRED_SIZE,
								...
								.addContainerGap()));
		jPanelCompraManualLayout.setVerticalGroup(jPanelCompraManualLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanelCompraManualLayout.createSequentialGroup()
						.addComponent(jPanelSubComprar, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanelCompraManualLayout
								.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabelMelhorAsk).addComponent(jTextFieldMelhorAsk,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanelCompraManualLayout
								.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabelComprarQuantidade).addComponent(jTextFieldComprarQuantidade,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanelCompraManualLayout
								.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabelComprarTotal).addComponent(jTextFieldComprarTotal,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 12, Short.MAX_VALUE)
						.addGroup(
								jPanelCompraManualLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
										.addComponent(jButtonComprarManual).addComponent(jLabelFeeCompra)
										.addComponent(jButtonComprarManualTudo))
						.addContainerGap()));
		...
		jTextFieldVenderQuantidade.setHorizontalAlignment(SwingConstants.RIGHT);
		...
		jTextFieldVenderTotal.setHorizontalAlignment(SwingConstants.RIGHT);
		...
		jPanelSubVenderLayout.setHorizontalGroup(
				jPanelSubVenderLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(
						jLabelVender, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE,
						javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE));
		jPanelSubVenderLayout
				.setVerticalGroup(jPanelSubVenderLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addComponent(jLabelVender, javax.swing.GroupLayout.Alignment.TRAILING,
								javax.swing.GroupLayout.DEFAULT_SIZE, 28, Short.MAX_VALUE));
		...
		jPanelVendaManualLayout.setHorizontalGroup(jPanelVendaManualLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addComponent(jPanelSubVender, javax.swing.GroupLayout.DEFAULT_SIZE,
						javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
				.addGroup(jPanelVendaManualLayout.createSequentialGroup().addContainerGap()
						.addGroup(jPanelVendaManualLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(jPanelVendaManualLayout.createSequentialGroup()
										.addComponent(jLabelFeeVenda, javax.swing.GroupLayout.PREFERRED_SIZE, 99,
												javax.swing.GroupLayout.PREFERRED_SIZE)
								...
								.addGroup(jPanelVendaManualLayout.createSequentialGroup()
										.addGroup(jPanelVendaManualLayout
												.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
												.addComponent(jLabelMelhorBid).addComponent(jLabelVenderQuantidade)
						...
						.addContainerGap()));
		jPanelVendaManualLayout.setVerticalGroup(jPanelVendaManualLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanelVendaManualLayout.createSequentialGroup()
						.addComponent(jPanelSubVender, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanelVendaManualLayout
								.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabelMelhorBid).addComponent(jTextFieldMelhorBid,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanelVendaManualLayout
								.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabelVenderQuantidade).addComponent(jTextFieldVenderQuantidade,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanelVendaManualLayout
								.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabelVenderTotal).addComponent(jTextFieldVenderTotal,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 12, Short.MAX_VALUE)
						.addGroup(
								jPanelVendaManualLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
										.addComponent(jButtonVenderManual).addComponent(jLabelFeeVenda)
										.addComponent(jButtonVenderManualTudo))
						.addContainerGap()));
		...
		jPanelSubFundosLayout.setHorizontalGroup(
				jPanelSubFundosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(
						jLabelFundos, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE,
						javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE));
		jPanelSubFundosLayout
				.setVerticalGroup(jPanelSubFundosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addComponent(jLabelFundos, javax.swing.GroupLayout.Alignment.TRAILING,
								javax.swing.GroupLayout.DEFAULT_SIZE, 28, Short.MAX_VALUE));
		...
		jTextFieldMoedaBaseAtual.setHorizontalAlignment(SwingConstants.RIGHT);
		...
		jTextFieldMoedaCotacaoAtual.setHorizontalAlignment(SwingConstants.RIGHT);
		...
		jPanelFundosLayout.setHorizontalGroup(jPanelFundosLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addComponent(jPanelSubFundos, javax.swing.GroupLayout.DEFAULT_SIZE,
						javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
				.addGroup(jPanelFundosLayout.createSequentialGroup().addContainerGap().addGroup(jPanelFundosLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addComponent(jButtonAlterarFundos, javax.swing.GroupLayout.Alignment.TRAILING,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
								Short.MAX_VALUE)
						.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
								jPanelFundosLayout.createSequentialGroup().addGroup(jPanelFundosLayout
										.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addComponent(jLabelMoedaBaseAtual).addComponent(jLabelMoedaCotacaoAtual))
										.addGap(23, 23, 23)
										.addGroup(jPanelFundosLayout
												.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
												.addComponent(jTextFieldMoedaBaseAtual)
												.addComponent(jTextFieldMoedaCotacaoAtual)))
						.addComponent(jLabelTotalFundos, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
						.addContainerGap()));
		jPanelFundosLayout.setVerticalGroup(jPanelFundosLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanelFundosLayout.createSequentialGroup()
						.addComponent(jPanelSubFundos, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanelFundosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabelMoedaBaseAtual).addComponent(jTextFieldMoedaBaseAtual,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanelFundosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabelMoedaCotacaoAtual).addComponent(jTextFieldMoedaCotacaoAtual,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						...
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addComponent(jButtonAlterarFundos).addContainerGap()));
		...
		jPanelSubLayout
				.setHorizontalGroup(jPanelSubLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(jPanelSubLayout.createSequentialGroup().addContainerGap()
								.addComponent(jLabelID, javax.swing.GroupLayout.PREFERRED_SIZE, 240,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(jLabelTipoTransacao, javax.swing.GroupLayout.PREFERRED_SIZE, 93,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
								.addComponent(jLabelPrecoTransacao, javax.swing.GroupLayout.PREFERRED_SIZE, 93,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
								.addComponent(jLabelQuantidadeTransacao, javax.swing.GroupLayout.PREFERRED_SIZE, 126,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
								.addComponent(jLabelTimestampTransacao, javax.swing.GroupLayout.PREFERRED_SIZE, 182,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addContainerGap()));
		jPanelSubLayout.setVerticalGroup(jPanelSubLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanelSubLayout.createSequentialGroup().addContainerGap()
						.addGroup(jPanelSubLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabelID, javax.swing.GroupLayout.PREFERRED_SIZE, 20,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jLabelPrecoTransacao, javax.swing.GroupLayout.PREFERRED_SIZE, 20,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jLabelTipoTransacao, javax.swing.GroupLayout.PREFERRED_SIZE, 20,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jLabelTimestampTransacao, javax.swing.GroupLayout.PREFERRED_SIZE, 20,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jLabelQuantidadeTransacao, javax.swing.GroupLayout.PREFERRED_SIZE, 20,
										javax.swing.GroupLayout.PREFERRED_SIZE))
		...
		jPanelHeaderTransacoesLayout.setHorizontalGroup(jPanelHeaderTransacoesLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jPanelSub,
						javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE,
						javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE));
		jPanelHeaderTransacoesLayout.setVerticalGroup(jPanelHeaderTransacoesLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jPanelSub,
						javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE,
						javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE));
		...
		jPanelSubTransacoesLayout.setHorizontalGroup(
				jPanelSubTransacoesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(
						jLabelTransacoes, javax.swing.GroupLayout.Alignment.TRAILING,
						javax.swing.GroupLayout.DEFAULT_SIZE, 948, Short.MAX_VALUE));
		...
		jPanelLinhasTransacoesLayout.setHorizontalGroup(jPanelLinhasTransacoesLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 1119, Short.MAX_VALUE));
		jPanelLinhasTransacoesLayout.setVerticalGroup(jPanelLinhasTransacoesLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 379, Short.MAX_VALUE));
		...
		jPanelTransacoesLayout.setHorizontalGroup(jPanelTransacoesLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addComponent(jPanelSubTransacoes, javax.swing.GroupLayout.DEFAULT_SIZE,
						javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
				.addGroup(jPanelTransacoesLayout.createSequentialGroup().addContainerGap()
						.addGroup(jPanelTransacoesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(jPanelHeaderTransacoes, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(jScrollPaneLinhasTransacoes, javax.swing.GroupLayout.PREFERRED_SIZE, 0,
										Short.MAX_VALUE))
						.addContainerGap()));
		jPanelTransacoesLayout
				.setVerticalGroup(jPanelTransacoesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(jPanelTransacoesLayout.createSequentialGroup()
								.addComponent(jPanelSubTransacoes, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(jPanelHeaderTransacoes, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(jScrollPaneLinhasTransacoes, javax.swing.GroupLayout.DEFAULT_SIZE, 318,
										Short.MAX_VALUE)
								.addContainerGap()));
		...
		jPanelSubTraderbotLayout.setHorizontalGroup(
				jPanelSubTraderbotLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(
						jLabelTraderbot, javax.swing.GroupLayout.Alignment.TRAILING,
		...
		jTextFieldParametrosTraderbot.setHorizontalAlignment(SwingConstants.LEFT);
		...
		jPanelTraderbotLayout.setHorizontalGroup(jPanelTraderbotLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addComponent(jPanelSubTraderbot, javax.swing.GroupLayout.DEFAULT_SIZE,
						javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelTraderbotLayout.createSequentialGroup()
						...
						.addGroup(jPanelTraderbotLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(jPanelTraderbotLayout.createSequentialGroup()
										...
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
										.addComponent(jComboBoxScriptAtualTraderbot,
										...
										.addGap(18, 18, 18).addComponent(jLabelStatusTrader)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
										.addComponent(jButtonAtivarDesativarTrader))
								.addGroup(jPanelTraderbotLayout.createSequentialGroup().addGap(0, 0, Short.MAX_VALUE)
										.addComponent(jCheckBoxSendTelegram)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
										.addComponent(jCheckBoxAutoTrade)))
						.addContainerGap()));
		jPanelTraderbotLayout.setVerticalGroup(jPanelTraderbotLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanelTraderbotLayout.createSequentialGroup()
						.addComponent(jPanelSubTraderbot, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanelTraderbotLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabelScriptAtualTraderbot)
								.addComponent(jComboBoxScriptAtualTraderbot, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jButtonAtivarDesativarTrader).addComponent(jLabelStatusTrader)
								.addComponent(jLabelScriptAtualTraderbot1).addComponent(jTextFieldParametrosTraderbot,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 10, Short.MAX_VALUE)
						.addGroup(jPanelTraderbotLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jCheckBoxSendTelegram).addComponent(jCheckBoxAutoTrade))
						.addContainerGap()));
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
				...
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addComponent(jPanelTransacoes, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addGroup(layout.createSequentialGroup()
								.addComponent(jPanelCompraManual, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(jPanelVendaManual, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(jPanelFundos, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
						.addComponent(jPanelTraderbot, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
				.addContainerGap()));
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup().addContainerGap()
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
								.addComponent(jPanelCompraManual, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(jPanelVendaManual, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(jPanelFundos, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(jPanelTransacoes, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(jPanelTraderbot, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addContainerGap()));
	...
	{// GEN-HEADEREND:event_jButtonAlterarFundosActionPerformed
		assetparser.submoduloofflinetrader.frame_adicionarremoverfundos mfarf = new assetparser.submoduloofflinetrader.frame_adicionarremoverfundos(
				this);
		mfarf.setVisible(true);
