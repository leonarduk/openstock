...
public class panel_submodulografico extends javax.swing.JPanel {
	...
	public void setarGraficoIndicadorSecundario(
			assetparser.submodulografico.panel_itemindicador mpiidestacarabaixo) {
		for (int i = 0; i < jPanelIndicadores.getComponentCount(); i++) {
			assetparser.submodulografico.panel_itemindicador miia = (assetparser.submodulografico.panel_itemindicador) jPanelIndicadores
					.getComponent(i);
	...
	void exportarcsvdados() {
		...
		try {
			...
			for (int i = 0; i < candles.size(); i++) {
				...
				String timestamp = (timestampatual.getYear() + 1900) + "-" + (timestampatual.getMonth() + 1) + "-"
						+ timestampatual.getDate() + "-" + timestampatual.getHours() + "-" + timestampatual.getMinutes()
						+ "-" + timestampatual.getSeconds();

				String nomdate = (timestampatual.getMonth() + 1) + "/" + timestampatual.getDate() + "/"
						+ (timestampatual.getYear() + 1900);

				String nomhour = timestampatual.getHours() + ":" + timestampatual.getMinutes() + ":"
						+ timestampatual.getSeconds();
