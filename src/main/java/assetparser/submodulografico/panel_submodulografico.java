...
public class panel_submodulografico extends javax.swing.JPanel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5852967013321922618L;
	// <editor-fold defaultstate="collapsed" desc="Variáveis Públicas">
	// analisador de asset pai, contem modulos para analises do asset (ateh o
	// momento grafico e trader)
	public assetparser.panel_submodulosholder submodulohpai;
	// classe utilizada para desenhar graficos
	public communication.mcchartgenerator mcg;
	// </editor-fold>

	// <editor-fold defaultstate="collapsed" desc="CONSTRUTOR">
	public panel_submodulografico(assetparser.panel_submodulosholder shpai) throws IOException {
		initComponents();
	...
	// <editor-fold defaultstate="collapsed" desc="Inicialização e
	// Recarregamento">
	void inicializarsubmodulografico() throws IOException {
		// popular objeto utilizado para desenho de graficos
		mcg = new communication.mcchartgenerator();
	...
	// funcao responsavel por criar o grafico com o simbolo e periodo desejado pela
	// primeira vez
	public void recarregardadossubmodulografico(boolean resetaranotacoesindicadores) throws IOException {
		// funcao para carregar submodulo grafico, pode ser necessario resetar anotacoes
		// e indicadores

		// <editor-fold defaultstate="collapsed" desc="Receber Candles do Asset
		// Desejado">
		...
		java.util.List<communication.mccandle> candles = null;
		...
		if ((sourcesimboloescolhido.equals("testdata")) == true) {
			...
			if (((sourcesimboloescolhido.split(":")[0]).toLowerCase()).equals("iex")) {
				if (periodoescolhido.equals("1 Day"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
				...
				if (periodoescolhido.equals("1 minute (Compact)"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.av_receberstockcandlesintraday((sourcesimboloescolhido.split(":")[1]), "1min", "compact");
				else if (periodoescolhido.equals("1 minute (Full)"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.av_receberstockcandlesintraday((sourcesimboloescolhido.split(":")[1]), "1min", "full");
				else if (periodoescolhido.equals("5 minutes (Compact)"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.av_receberstockcandlesintraday((sourcesimboloescolhido.split(":")[1]), "5min", "compact");
				else if (periodoescolhido.equals("5 minutes (Full)"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.av_receberstockcandlesintraday((sourcesimboloescolhido.split(":")[1]), "5min", "full");
				else if (periodoescolhido.equals("15 minutes (Compact)"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.av_receberstockcandlesintraday((sourcesimboloescolhido.split(":")[1]), "15min", "compact");
				else if (periodoescolhido.equals("15 minutes (Full)"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.av_receberstockcandlesintraday((sourcesimboloescolhido.split(":")[1]), "15min", "full");
				else if (periodoescolhido.equals("30 minutes (Compact)"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.av_receberstockcandlesintraday((sourcesimboloescolhido.split(":")[1]), "30min", "compact");
				else if (periodoescolhido.equals("30 minutes (Full)"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.av_receberstockcandlesintraday((sourcesimboloescolhido.split(":")[1]), "30min", "full");
				else if (periodoescolhido.equals("60 minutes (Compact)"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.av_receberstockcandlesintraday((sourcesimboloescolhido.split(":")[1]), "60min", "compact");
				else if (periodoescolhido.equals("60 minutes (Full)"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.av_receberstockcandlesintraday((sourcesimboloescolhido.split(":")[1]), "60min", "full");
				else if (periodoescolhido.equals("Daily (Compact)"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.av_receberstockcandlesdaily((sourcesimboloescolhido.split(":")[1]), "compact");
				else if (periodoescolhido.equals("Daily (Full)"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.av_receberstockcandlesdaily((sourcesimboloescolhido.split(":")[1]), "full");
				else if (periodoescolhido.equals("Weekly"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.av_receberstockcandlesweekly((sourcesimboloescolhido.split(":")[1]));
				else if (periodoescolhido.equals("Monthly"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.av_receberstockcandlesmonthly((sourcesimboloescolhido.split(":")[1]));
				...
				if (periodoescolhido.equals("1 minute (Compact)"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.av_receberforexcandlesintraday(fromsimbolo, tosimbolo, "1min", "compact");
				else if (periodoescolhido.equals("1 minute (Full)"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.av_receberforexcandlesintraday(fromsimbolo, tosimbolo, "1min", "full");
				else if (periodoescolhido.equals("5 minutes (Compact)"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.av_receberforexcandlesintraday(fromsimbolo, tosimbolo, "5min", "compact");
				else if (periodoescolhido.equals("5 minutes (Full)"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.av_receberforexcandlesintraday(fromsimbolo, tosimbolo, "5min", "full");
				else if (periodoescolhido.equals("15 minutes (Compact)"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.av_receberforexcandlesintraday(fromsimbolo, tosimbolo, "15min", "compact");
				else if (periodoescolhido.equals("15 minutes (Full)"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.av_receberforexcandlesintraday(fromsimbolo, tosimbolo, "15min", "full");
				else if (periodoescolhido.equals("30 minutes (Compact)"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.av_receberforexcandlesintraday(fromsimbolo, tosimbolo, "30min", "compact");
				else if (periodoescolhido.equals("30 minutes (Full)"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.av_receberforexcandlesintraday(fromsimbolo, tosimbolo, "30min", "full");
				else if (periodoescolhido.equals("60 minutes (Compact)"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.av_receberforexcandlesintraday(fromsimbolo, tosimbolo, "60min", "compact");
				else if (periodoescolhido.equals("60 minutes (Full)"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.av_receberforexcandlesintraday(fromsimbolo, tosimbolo, "60min", "full");
				else if (periodoescolhido.equals("Daily (Compact)"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.av_receberforexcandlesdaily(fromsimbolo, tosimbolo, "compact");
				else if (periodoescolhido.equals("Daily (Full)"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.av_receberforexcandlesdaily(fromsimbolo, tosimbolo, "full");
				else if (periodoescolhido.equals("Weekly"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.av_receberforexcandlesweekly(fromsimbolo, tosimbolo);
				else if (periodoescolhido.equals("Monthly"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.av_receberforexcandlesmonthly(fromsimbolo, tosimbolo);
			} else if (((sourcesimboloescolhido.split(":")[0]).toLowerCase()).equals("crycom")) {
				if (periodoescolhido.equals("Minute (200)"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.crycom_recebercryptocandles((sourcesimboloescolhido.split(":")[1]), "200", "Minute");
				else if (periodoescolhido.equals("Minute (1500)"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.crycom_recebercryptocandles((sourcesimboloescolhido.split(":")[1]), "1500", "Minute");
				if (periodoescolhido.equals("Hourly (200)"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.crycom_recebercryptocandles((sourcesimboloescolhido.split(":")[1]), "200", "Hourly");
				else if (periodoescolhido.equals("Hourly (1500)"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.crycom_recebercryptocandles((sourcesimboloescolhido.split(":")[1]), "1500", "Hourly");
				if (periodoescolhido.equals("Daily (200)"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.crycom_recebercryptocandles((sourcesimboloescolhido.split(":")[1]), "200", "Daily");
				else if (periodoescolhido.equals("Daily (1500)"))
					candles = submodulohpai.assetpai.iaassetpai.tprincipalpai.msapicomms
							.crycom_recebercryptocandles((sourcesimboloescolhido.split(":")[1]), "1500", "Daily");
			}
		}
		// </editor-fold>

		// <editor-fold defaultstate="collapsed" desc="Utilizar Candles para Recarregar
		// OHLC">

		mcg.carregarohlc(candles, sourcesimboloescolhido + " (" + periodoescolhido + ")", escalagrafico,
				resetaranotacoesindicadores);
		...
		// <editor-fold defaultstate="collapsed" desc="Remover Todas Anotações e
		// Indicadores para o OHLC Novo - CASO RESET">
		...
		// <editor-fold defaultstate="collapsed" desc="Recarregar Anotações e
		// Indicadores para o OHLC Novo - CASO NAO RESET">
		else if (resetaranotacoesindicadores == false) {
			// <editor-fold defaultstate="collapsed" desc="Recarregar Dados e Plots dos
			// Indicadores">

			// comecar limpando graficamente os timeseries dos indicadores
			mcg.removerplotohlc_indicadores();

			// atualizar dados de todos os indicadores e adiciona-los novamente (os seus ids
			// ja existem)
			for (int i = 0; i < jPanelIndicadores.getComponentCount(); i++) {
				assetparser.submodulografico.panel_itemindicador novoindicador = (assetparser.submodulografico.panel_itemindicador) jPanelIndicadores
						.getComponent(i);
				...
				if (statusrunindicador.equals("ok")) {
					if (novoindicador.mcbcindicador.tipoplot_lastrun.equals("drawoncandles")) {
						// considerando que o indicador rodou com sucesso, e que ele deve ser desenhado
						// no ohlc,
						// adicionar dados do indicador no grafico
						mcg.adicionarplotohlc_indicador(novoindicador.mcbcindicador.pontosx_lastrun,
					...
					communication.mcfuncoeshelper.mostrarmensagem(
							"Algum problema ocorreu e o indicador não pôde ser utilizado:\n\n" + statusrunindicador);
				}
			...
			for (int i = 0; i < jPanelIndicadores.getComponentCount(); i++) {
				assetparser.submodulografico.panel_itemindicador miia = (assetparser.submodulografico.panel_itemindicador) jPanelIndicadores
						.getComponent(i);
			...
			// <editor-fold defaultstate="collapsed" desc="Recarregar Dados e Plots das
			// Anotacoes">
			...
			for (int i = 0; i < jPanelAnotacoes.getComponentCount(); i++) {
				assetparser.submodulografico.panel_itemanotacao novoanotacao = (assetparser.submodulografico.panel_itemanotacao) jPanelAnotacoes
						.getComponent(i);
	...
	public void adicionarIndicadorNovo(String idbc, String paramsbc) {
		...
		assetparser.submodulografico.panel_itemindicador novoindicador = new assetparser.submodulografico.panel_itemindicador(
				this, idbc, paramsbc);
		...
		if (statusrunindicador.equals("ok")) {
			if (novoindicador.mcbcindicador.tipoplot_lastrun.equals("drawoncandles")) {
				...
				// adicionar dados do indicador no grafico
				mcg.adicionarplotohlc_indicador(novoindicador.mcbcindicador.pontosx_lastrun,
						novoindicador.mcbcindicador.pontosy_lastrun, novoindicador.mcbcindicador.tituloscript_lastrun);
	...
	public void removerIndicador(assetparser.submodulografico.panel_itemindicador mpiiremover) {
	...
	public void setarGraficoIndicadorSecundario(assetparser.submodulografico.panel_itemindicador mpiidestacarabaixo) {
		for (int i = 0; i < jPanelIndicadores.getComponentCount(); i++) {
			assetparser.submodulografico.panel_itemindicador miia = (assetparser.submodulografico.panel_itemindicador) jPanelIndicadores
					.getComponent(i);
		...
		// funcao que pega o grafico separado deste indicador e o separa para ficar logo
		// abaixo do grafico ohlc
		// principal, tambem eh desejavel que quando o usuario estiver realizando zoom
		// no grafico ohlc,
		...
		jPanelSecondaryChartPanel.add(mpiidestacarabaixo.mfcs.retornarnovoplot_indicador(
	...
	void adicionarAnotacaoNovo() {
		java.util.List<org.jfree.chart.annotations.XYAnnotation> lista_xyannotations = mcg
				.retornar_xyannotations_das_anotacoes();
		...
		// caso a quantidade de quantidade_xyannotations_ohlc seja maior que
		// quantidadeids_listacontroleanotacao
		// quer dizer que existem mais xyannotations no grafico OHLC, do que ids de
		// controle, ou seja, existe uma anotacao nova, que contem uma nova lista de
		// xyannotations
		if (quantidade_xyannotations_ohlc > quantidadeids_listacontroleanotacao) {
			// criar novo item anotacao
			assetparser.submodulografico.panel_itemanotacao novompia = new assetparser.submodulografico.panel_itemanotacao(
					this, mcg.anotacaoselecionada, mcg.anotacao_emhold);
	...
	public void adicionarAnotacaoLoad(String nome, String id, String tipo,
			java.util.List<org.jfree.chart.annotations.XYAnnotation> anotacao) {
		// funcao para adicionar nova anotacao em modo de carregamento

		// criar novo item de anotacao
		assetparser.submodulografico.panel_itemanotacao novompia = new assetparser.submodulografico.panel_itemanotacao(
				this, nome, id, tipo, anotacao);
	...
	public void removerAnotacao(assetparser.submodulografico.panel_itemanotacao mpiaremover) {
	...
	// <editor-fold defaultstate="collapsed" desc="Funcoes de interpretacao de mouse
	// events do jfreechart">
	...
	void atualizarrangegraficosecundario() {
		// funcao para atualizar o range do grafico secundario, para ser igual ao do
		// grafico primario
		...
		if (jPanelSecondaryChartPanel.getComponentCount() == 1) {
			...
			// org.jfree.chart.plot.XYPlot plotohlc =
			// (org.jfree.chart.plot.XYPlot)chartohlc.getPlot();
			// org.jfree.data.Range rangexohlc = plotohlc.getDomainAxis().getRange();

			org.jfree.chart.ChartPanel chartpanelsecundario = (org.jfree.chart.ChartPanel) jPanelSecondaryChartPanel
					.getComponent(0);
	...
	void exportarcsvdados() {
		...
		try {
			...
			for (int j = 0; j < jPanelIndicadores.getComponentCount(); j++) {
				assetparser.submodulografico.panel_itemindicador indicadoratual = (assetparser.submodulografico.panel_itemindicador) jPanelIndicadores
						.getComponent(j);
			...
			java.util.List<communication.mccandle> candles = mcg.mcg_candles;
			for (int i = 0; i < candles.size(); i++) {
				communication.mccandle candleatual = candles.get(i);

				Calendar cal = Calendar.getInstance();
				cal.setTime(candleatual.timestampdate);


				String nomdate = cal.get(Calendar.MONTH + 1) + "/" + cal.get(Calendar.DAY_OF_MONTH) + "/"
						+ (cal.get(Calendar.YEAR) + 1900);

				String nomhour = cal.get(Calendar.HOUR) + ":" + cal.get(Calendar.MINUTE) + ":"
						+ cal.get(Calendar.SECOND);

				String timestamp = cal.get(Calendar.YEAR) + "-" + cal.get(Calendar.MONTH + 1) + "-"
						+ cal.get(Calendar.DAY_OF_MONTH) + "-" + nomhour;
				...
				csvSave = csvSave + timestamp + ";" + nomdate + ";" + nomhour + ";" + String.valueOf(openatual) + ";"
						+ String.valueOf(highatual) + ";" + String.valueOf(lowatual) + ";" + String.valueOf(closeatual)
						+ ";" + String.valueOf(volumeatual);

				for (int j = 0; j < jPanelIndicadores.getComponentCount(); j++) {
					assetparser.submodulografico.panel_itemindicador indicadoratual = (assetparser.submodulografico.panel_itemindicador) jPanelIndicadores
							.getComponent(j);
					double valoryindicador = indicadoratual.retornarpontoy_dadotimestamp(candleatual.timestampdate);
			...
			if (userSelection == javax.swing.JFileChooser.APPROVE_OPTION) {
				...
				writer.close();
				communication.mcfuncoeshelper.mostrarmensagem(".csv file exported.");
			}

		} catch (Exception ex) {
			communication.mcfuncoeshelper
					.mostrarmensagem("A problem occurred when exporting. Exception: " + ex.getMessage());
		}
	...
	private void initComponents() {
		...
		jPanelFerramentasInfoLayout.setHorizontalGroup(jPanelFerramentasInfoLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanelFerramentasInfoLayout.createSequentialGroup().addContainerGap()
						...
						.addComponent(jLabelPainelInferior, javax.swing.GroupLayout.PREFERRED_SIZE, 20,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addContainerGap()));
		jPanelFerramentasInfoLayout.setVerticalGroup(jPanelFerramentasInfoLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanelFerramentasInfoLayout.createSequentialGroup().addContainerGap()
						.addGroup(jPanelFerramentasInfoLayout
								.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(jPanelFerramentasInfoLayout.createSequentialGroup()
										.addComponent(jLabelPainelInferior).addGap(0, 0, Short.MAX_VALUE))
								.addGroup(jPanelFerramentasInfoLayout
										.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
										.addComponent(jButtonAtivarSelecao, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addComponent(jButtonAtivarReta, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addComponent(jButtonExportarCsv, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addComponent(jButtonAtivarRegua, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addComponent(jButtonAtivarTexto, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addComponent(jButtonAtivarFibonacci, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
						.addContainerGap()));
		...
		jPanelOHLCChartpanelLayout.setHorizontalGroup(jPanelOHLCChartpanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 0, Short.MAX_VALUE));
		jPanelOHLCChartpanelLayout.setVerticalGroup(jPanelOHLCChartpanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 0, Short.MAX_VALUE));
		...
		javax.swing.GroupLayout jPanelSecondaryChartPanelLayout = new javax.swing.GroupLayout(
				jPanelSecondaryChartPanel);
		jPanelSecondaryChartPanel.setLayout(jPanelSecondaryChartPanelLayout);
		jPanelSecondaryChartPanelLayout.setHorizontalGroup(jPanelSecondaryChartPanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 0, Short.MAX_VALUE));
		jPanelSecondaryChartPanelLayout.setVerticalGroup(jPanelSecondaryChartPanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 0, Short.MAX_VALUE));
		...
		jPanelChartHoldersLayout.setHorizontalGroup(jPanelChartHoldersLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jSplitPaneChartpanels));
		jPanelChartHoldersLayout.setVerticalGroup(
				jPanelChartHoldersLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(
						jSplitPaneChartpanels, javax.swing.GroupLayout.DEFAULT_SIZE, 421, Short.MAX_VALUE));
				...
				.addGroup(jPanelPrincipalLayout.createSequentialGroup().addContainerGap()
						.addGroup(jPanelPrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
										jPanelPrincipalLayout.createSequentialGroup().addComponent(jLabelNomeSimbolo)
												.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
												.addComponent(jTextFieldNomeSimbolo)
												.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
												.addComponent(jButtonEscolherSimbolo))
								.addGroup(
										jPanelPrincipalLayout.createSequentialGroup().addComponent(jLabelPeriodoSimbolo)
												.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
												.addComponent(jComboBoxPeriodoSimbolo, 0,
														javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
								.addGroup(jPanelPrincipalLayout.createSequentialGroup().addGap(5, 5, 5)
										.addComponent(jLabelLinearSwitch).addGap(18, 18, 18)
								...
								.addGroup(jPanelPrincipalLayout.createSequentialGroup()
										.addComponent(jButtonCarregarConfiguracao, javax.swing.GroupLayout.DEFAULT_SIZE,
												164, Short.MAX_VALUE)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
										.addComponent(jButtonSalvarConfiguracao, javax.swing.GroupLayout.PREFERRED_SIZE,
		...
		jPanelPrincipalLayout.setVerticalGroup(jPanelPrincipalLayout
				...
				.addGroup(jPanelPrincipalLayout.createSequentialGroup().addContainerGap()
						.addGroup(jPanelPrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jButtonEscolherSimbolo).addComponent(jLabelNomeSimbolo)
								.addComponent(jTextFieldNomeSimbolo, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanelPrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jComboBoxPeriodoSimbolo, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jLabelPeriodoSimbolo))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanelPrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jButtonAtualizarDadosGrafico).addComponent(jLabelLinearSwitch)
								.addComponent(jLabelLogaritmicaSwitch))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addGroup(jPanelPrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jButtonSalvarConfiguracao).addComponent(jButtonCarregarConfiguracao))
						.addContainerGap()));
		...
		jPanelPrincipalPaiLayout.setHorizontalGroup(
				jPanelPrincipalPaiLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addComponent(jPanelPrincipal, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addGroup(
								jPanelPrincipalPaiLayout.createSequentialGroup().addContainerGap()
										.addComponent(jLabelMain, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addContainerGap()));
		jPanelPrincipalPaiLayout.setVerticalGroup(
				jPanelPrincipalPaiLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(jPanelPrincipalPaiLayout.createSequentialGroup().addContainerGap()
								.addComponent(jLabelMain, javax.swing.GroupLayout.PREFERRED_SIZE, 22,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
								.addComponent(jPanelPrincipal, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		...
		jPanelIndicadoresLayout.setHorizontalGroup(jPanelIndicadoresLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 398, Short.MAX_VALUE));
		jPanelIndicadoresLayout.setVerticalGroup(jPanelIndicadoresLayout
		...
		jPanelIndicadoresPaiLayout.setHorizontalGroup(
				jPanelIndicadoresPaiLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						...
						.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
								jPanelIndicadoresPaiLayout.createSequentialGroup().addContainerGap()
										.addComponent(jLabelIndicadores, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addGap(68, 68, 68).addComponent(jButtonAdicionarIndicador).addContainerGap()));
		jPanelIndicadoresPaiLayout.setVerticalGroup(jPanelIndicadoresPaiLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanelIndicadoresPaiLayout.createSequentialGroup().addContainerGap()
						.addGroup(jPanelIndicadoresPaiLayout
								.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabelIndicadores, javax.swing.GroupLayout.PREFERRED_SIZE, 22,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jButtonAdicionarIndicador, javax.swing.GroupLayout.PREFERRED_SIZE, 22,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
		...
		jPanelAnotacoesLayout.setHorizontalGroup(jPanelAnotacoesLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 858, Short.MAX_VALUE));
		jPanelAnotacoesLayout.setVerticalGroup(jPanelAnotacoesLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 298, Short.MAX_VALUE));
		...
		jPanelAnotacoesPaiLayout
				.setHorizontalGroup(
						jPanelAnotacoesPaiLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
								.addGroup(jPanelAnotacoesPaiLayout.createSequentialGroup().addContainerGap()
										.addComponent(jLabelAnotacoes, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addContainerGap()));
		jPanelAnotacoesPaiLayout.setVerticalGroup(jPanelAnotacoesPaiLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanelAnotacoesPaiLayout.createSequentialGroup().addContainerGap()
						.addComponent(jLabelAnotacoes, javax.swing.GroupLayout.PREFERRED_SIZE, 22,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)));
		...
		jPanelInferiorLayout
				.setHorizontalGroup(jPanelInferiorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(jPanelInferiorLayout.createSequentialGroup()
								.addComponent(jPanelPrincipalPai, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(jPanelIndicadoresPai, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(jPanelAnotacoesPai, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		jPanelInferiorLayout.setVerticalGroup(jPanelInferiorLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanelInferiorLayout.createSequentialGroup().addContainerGap()
						.addGroup(jPanelInferiorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(jPanelIndicadoresPai, javax.swing.GroupLayout.Alignment.TRAILING,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										Short.MAX_VALUE)
								.addComponent(jPanelPrincipalPai, javax.swing.GroupLayout.Alignment.TRAILING,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										Short.MAX_VALUE)
								.addComponent(jPanelAnotacoesPai, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup().addContainerGap()
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(jPanelChartHolders, javax.swing.GroupLayout.Alignment.TRAILING,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										Short.MAX_VALUE)
								.addComponent(jPanelFerramentasInfo, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(jPanelInferior, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
						.addContainerGap()));
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				javax.swing.GroupLayout.Alignment.TRAILING,
				layout.createSequentialGroup().addContainerGap()
						.addComponent(jPanelChartHolders, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(jPanelFerramentasInfo, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addGap(18, 18, 18)
						.addComponent(jPanelInferior, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addContainerGap()));
	...
	{// GEN-HEADEREND:event_jButtonAdicionarIndicadorActionPerformed
		assetparser.submodulografico.frame_adicionarindicador mfai = new assetparser.submodulografico.frame_adicionarindicador(
				this);
		mfai.setVisible(true);
	}// GEN-LAST:event_jButtonAdicionarIndicadorActionPerformed

	private void jButtonAtualizarDadosGraficoActionPerformed(java.awt.event.ActionEvent evt) throws IOException// GEN-FIRST:event_jButtonAtualizarDadosGraficoActionPerformed
	...
	{// GEN-HEADEREND:event_jButtonEscolherSimboloActionPerformed
		assetparser.submodulografico.frame_adicionarsimbolo as = new assetparser.submodulografico.frame_adicionarsimbolo(
				this, jTextFieldNomeSimbolo.getText());
		as.setVisible(true);
