...
public class panel_itemindicador extends javax.swing.JPanel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3302941099372132252L;

	// submodulo grafico ao qual este item indicador pertence
	public assetparser.submodulografico.panel_submodulografico submodulografico;

	// classe interpretadora de bearcode (contem o codigo relacionado a este
	// indicador)
	public communication.mcbcindicatorinterpreter mcbcindicador;

	// grafico separado deste item indicador
	public assetparser.submodulografico.frame_chartseparado mfcs;
	...
	public panel_itemindicador(assetparser.submodulografico.panel_submodulografico mpsmg, String idbearcode,
			String parametrosbearcode) {
		initComponents();
	...
	public panel_itemindicador(assetparser.submodulografico.panel_submodulografico mpsmg, String idind, String nome,
			String idbearcode, String parametrosbearcode) {
		initComponents();
	...
	public void criargraficoseparadoindicador() {
		// funcao para criar chartseparado com grafico separado deste indicador, e
		// associa-lo a este
		// mpitemindicador, para poder ser acessado ao clicar no botao G
		mfcs = new assetparser.submodulografico.frame_chartseparado();
	...
	public void recarregargraficoseparadoindicador() {
		 ...
		 */
		mfcs.associarplotchartpaneljanela(mfcs.retornarnovoplot_indicador(mcbcindicador.pontosx_lastrun,
				mcbcindicador.pontosy_lastrun, mcbcindicador.tituloscript_lastrun, mcbcindicador.tipoplot_lastrun));
	...
	void popularbearcodeindicador(String idbearcode, String parametrosbearcode) {
		...
		try {
			caminhoarquivobci = new File(getClass().getClassLoader().getResource("bearcode/indicators").getFile())
					.getAbsolutePath();
		...
		mcbcindicador = new communication.mcbcindicatorinterpreter(idbci, nomebci, conteudoscriptbci, parametrosbearcode);
		// mierclasses.mcfuncoeshelper.mostrarmensagem("mcbcindicador.tipobcode: " +
		// mcbcindicador.tipobcode);
		// mierclasses.mcfuncoeshelper.mostrarmensagem("mcbcindicador.idbcode: " +
		// mcbcindicador.idbcode);
		// mierclasses.mcfuncoeshelper.mostrarmensagem("mcbcindicador.nomebcode: " +
		// mcbcindicador.nomebcode);
		// mierclasses.mcfuncoeshelper.mostrarmensagem("mcbcindicador.parametrosbcodejs:
		// " + mcbcindicador.parametrosbcodejs);
		// mierclasses.mcfuncoeshelper.mostrarmensagem("mcbcindicador.codigobcodejs: " +
		// mcbcindicador.codigobcodejs);
	}
	...
	private void initComponents() {
		...
		jLabelAbrirJanelaRenomearItemIndicador
				.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/penyellow.png"))); // NOI18N
		...
		jLabelAbrirJanelaMostrarGraficoSeparado
				.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/graphblue.png"))); // NOI18N
		...
		jLabelEscolherGraficoParaBottom
				.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/upgray.png"))); // NOI18N
		...
		jPanelSubLayout
				.setHorizontalGroup(jPanelSubLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(jPanelSubLayout.createSequentialGroup().addContainerGap()
								.addComponent(jLabelNomeItemIndicador, javax.swing.GroupLayout.DEFAULT_SIZE, 113,
										Short.MAX_VALUE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(jLabelEscolherGraficoParaBottom, javax.swing.GroupLayout.PREFERRED_SIZE,
								...
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
								.addComponent(jLabeRemoverItemIndicador, javax.swing.GroupLayout.PREFERRED_SIZE, 18,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addContainerGap()));
		jPanelSubLayout.setVerticalGroup(jPanelSubLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanelSubLayout.createSequentialGroup().addContainerGap().addGroup(jPanelSubLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
						.addComponent(jLabelAbrirJanelaRenomearItemIndicador, javax.swing.GroupLayout.Alignment.LEADING,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
								Short.MAX_VALUE)
						.addComponent(jLabeRemoverItemIndicador, javax.swing.GroupLayout.Alignment.LEADING,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
								Short.MAX_VALUE)
						.addComponent(jLabelAbrirJanelaMostrarGraficoSeparado, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addComponent(jLabelEscolherGraficoParaBottom, javax.swing.GroupLayout.Alignment.LEADING)
						.addComponent(jLabelNomeItemIndicador, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				...
				layout.createSequentialGroup().addContainerGap().addComponent(jPanelSub,
						javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addContainerGap()));
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup().addContainerGap().addComponent(jPanelSub,
						javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addContainerGap()));
	...
	{// GEN-HEADEREND:event_jLabelAbrirJanelaRenomearItemIndicadorMouseClicked
		assetparser.submodulografico.frame_renomearitemindicador mfrii = new assetparser.submodulografico.frame_renomearitemindicador(
				this);
		mfrii.setVisible(true);
