...
public class panel_itemanotacao extends javax.swing.JPanel
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2154693301851925820L;
    ...
    public panel_itemanotacao(assetparser.submodulografico.panel_submodulografico smg, String tipo, java.util.List<org.jfree.chart.annotations.XYAnnotation> subans)
    {
        initComponents();
    ...
    public panel_itemanotacao(assetparser.submodulografico.panel_submodulografico smg, String nome, String idan, String tipo, java.util.List<org.jfree.chart.annotations.XYAnnotation> subans)
    {
        initComponents();
    ...
    {//GEN-HEADEREND:event_jLabelAbrirJanelaRenomearItemAnotacaoMouseClicked
        assetparser.submodulografico.frame_renomearitemanotacao mfrig = new assetparser.submodulografico.frame_renomearitemanotacao(this);
