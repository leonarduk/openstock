...
public class frame_telaprincipal extends javax.swing.JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 9091999787510595684L;
	...
	void interpretarconfiggerais() {
		...
		try {
			...
			File xmlArquivo = new File(getClass().getClassLoader().getResource("general.mfxconfig").getFile());
	...
	public void selecionarItemAnalisadorAsset(assetparser.panel_itemanalisadorasset mpigselecionar) {
		...
		// pintar o item grafico desejado com cor de destaque, para demonstrar que este
		// eh o grafico em uso no momento
	...
	private void initComponents() {
		...
		javax.swing.GroupLayout jPanelHolderAnalisadorAssetLayout = new javax.swing.GroupLayout(
				jPanelHolderAnalisadorAsset);
		jPanelHolderAnalisadorAsset.setLayout(jPanelHolderAnalisadorAssetLayout);
		jPanelHolderAnalisadorAssetLayout.setHorizontalGroup(jPanelHolderAnalisadorAssetLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 696, Short.MAX_VALUE));
		jPanelHolderAnalisadorAssetLayout.setVerticalGroup(jPanelHolderAnalisadorAssetLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 575, Short.MAX_VALUE));
		...
		javax.swing.GroupLayout jPanelItensAnalisadorAssetLayout = new javax.swing.GroupLayout(
				jPanelItensAnalisadorAsset);
		jPanelItensAnalisadorAsset.setLayout(jPanelItensAnalisadorAssetLayout);
		jPanelItensAnalisadorAssetLayout.setHorizontalGroup(jPanelItensAnalisadorAssetLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 311, Short.MAX_VALUE));
		jPanelItensAnalisadorAssetLayout.setVerticalGroup(jPanelItensAnalisadorAssetLayout
		...
		javax.swing.GroupLayout jPanelHolderTelaPrincipalLayout = new javax.swing.GroupLayout(
				jPanelHolderTelaPrincipal);
		jPanelHolderTelaPrincipal.setLayout(jPanelHolderTelaPrincipalLayout);
		jPanelHolderTelaPrincipalLayout.setHorizontalGroup(jPanelHolderTelaPrincipalLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanelHolderTelaPrincipalLayout.createSequentialGroup().addContainerGap()
						.addGroup(jPanelHolderTelaPrincipalLayout
								...
								.addComponent(jButtonJanelaConfiguracoes, javax.swing.GroupLayout.Alignment.LEADING,
										javax.swing.GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE)
								.addComponent(jScrollPane1, javax.swing.GroupLayout.Alignment.LEADING,
										javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(jPanelHolderAnalisadorAsset, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		jPanelHolderTelaPrincipalLayout.setVerticalGroup(
				jPanelHolderTelaPrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						...
						.addGroup(jPanelHolderTelaPrincipalLayout.createSequentialGroup().addContainerGap()
								...
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(jButtonJanelaConfiguracoes).addContainerGap()));

		javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
		getContentPane().setLayout(layout);
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(
				jPanelHolderTelaPrincipal, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
				Short.MAX_VALUE));
	...
	private void jButtonAdicionarAnalisadorAssetActionPerformed(java.awt.event.ActionEvent evt) throws IOException {// GEN-FIRST:event_jButtonAdicionarAnalisadorAssetActionPerformed
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(frame_telaprincipal.class.getName()).log(java.util.logging.Level.SEVERE,
					null, ex);
