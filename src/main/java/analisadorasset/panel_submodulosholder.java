...
public class panel_submodulosholder extends javax.swing.JPanel {
	...
	public panel_submodulosholder(analisadorasset.panel_analisadorasset aapai) throws IOException {
		initComponents();
	...
	// Asset e Timer">
	void inicializar(analisadorasset.panel_analisadorasset aapai) throws IOException {
	...
	public void salvardadosasset() {
		...
		try {
			...
			for (int i = 0; i < subgrafico.jPanelIndicadores.getComponentCount(); i++) {
				analisadorasset.submodulografico.panel_itemindicador miia = (analisadorasset.submodulografico.panel_itemindicador) subgrafico.jPanelIndicadores
						.getComponent(i);
			...
			for (int i = 0; i < subgrafico.jPanelAnotacoes.getComponentCount(); i++) {
				analisadorasset.submodulografico.panel_itemanotacao miaa = (analisadorasset.submodulografico.panel_itemanotacao) subgrafico.jPanelAnotacoes
						.getComponent(i);
			...
			for (int i = 0; i < subtrader.otrader.transacoes.size(); i++) {
				mierclasses.mcofflinetransaction transacaoatual = (mierclasses.mcofflinetransaction) subtrader.otrader.transacoes
						.get(i);
