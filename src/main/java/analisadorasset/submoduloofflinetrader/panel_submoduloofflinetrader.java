...
public class panel_submoduloofflinetrader extends javax.swing.JPanel {
	...
	void inicializarsubmoduloofflinetrader() {
		...
		for (int i = 0; i < otrader.transacoes.size(); i++) {
			jPanelLinhasTransacoes
					.add(new analisadorasset.submoduloofflinetrader.panel_itemtransacao(otrader.transacoes.get(i)));
		}
	...
	void repopularbearcodetraderbot(String idbearcode, String parametrosbearcode) {
		...
		mcbctradingbot = new mierclasses.mcbctradingbotinterpreter(idbci, nomebci, conteudoscriptbci,
				parametrosbearcode);
	}
	...
	{// GEN-HEADEREND:event_jButtonAlterarFundosActionPerformed
		analisadorasset.submoduloofflinetrader.frame_adicionarremoverfundos mfarf = new analisadorasset.submoduloofflinetrader.frame_adicionarremoverfundos(
				this);
		mfarf.show();
