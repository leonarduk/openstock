...
public class panel_submodulografico extends javax.swing.JPanel {
	...
	public panel_submodulografico(analisadorasset.panel_submodulosholder shpai) throws IOException {
		initComponents();
	...
	public void recarregardadossubmodulografico(boolean resetaranotacoesindicadores) throws IOException {
		...
		// Indicadores para o OHLC Novo - CASO NAO RESET">
			...
			for (int i = 0; i < jPanelIndicadores.getComponentCount(); i++) {
				analisadorasset.submodulografico.panel_itemindicador novoindicador = (analisadorasset.submodulografico.panel_itemindicador) jPanelIndicadores
						.getComponent(i);
			...
			for (int i = 0; i < jPanelAnotacoes.getComponentCount(); i++) {
				analisadorasset.submodulografico.panel_itemanotacao novoanotacao = (analisadorasset.submodulografico.panel_itemanotacao) jPanelAnotacoes
						.getComponent(i);
	...
	public void adicionarIndicadorNovo(String idbc, String paramsbc) {
		...
		analisadorasset.submodulografico.panel_itemindicador novoindicador = new analisadorasset.submodulografico.panel_itemindicador(
				this, idbc, paramsbc);
	...
	public void setarGraficoIndicadorSecundario(
			analisadorasset.submodulografico.panel_itemindicador mpiidestacarabaixo) {
		for (int i = 0; i < jPanelIndicadores.getComponentCount(); i++) {
			analisadorasset.submodulografico.panel_itemindicador miia = (analisadorasset.submodulografico.panel_itemindicador) jPanelIndicadores
					.getComponent(i);
	...
	void adicionarAnotacaoNovo() {
		...
		if (quantidade_xyannotations_ohlc > quantidadeids_listacontroleanotacao) {
			...
			analisadorasset.submodulografico.panel_itemanotacao novompia = new analisadorasset.submodulografico.panel_itemanotacao(
	...
	void exportarcsvdados() {
		...
		try {
			...
			for (int j = 0; j < jPanelIndicadores.getComponentCount(); j++) {
				analisadorasset.submodulografico.panel_itemindicador indicadoratual = (analisadorasset.submodulografico.panel_itemindicador) jPanelIndicadores
						.getComponent(j);
	...
	{// GEN-HEADEREND:event_jButtonAdicionarIndicadorActionPerformed
		analisadorasset.submodulografico.frame_adicionarindicador mfai = new analisadorasset.submodulografico.frame_adicionarindicador(
				this);
		mfai.show();
	...
	{// GEN-HEADEREND:event_jButtonEscolherSimboloActionPerformed
		analisadorasset.submodulografico.frame_adicionarsimbolo as = new analisadorasset.submodulografico.frame_adicionarsimbolo(
