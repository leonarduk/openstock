...
public class mcbcindicatorinterpreter
{
    ...
    public java.util.List<communication.mccandle> candles_lastrun;
    ...
    public String rodarscript(java.util.List<communication.mccandle> candlesscript, Boolean adicionarouthandler, communication.mcjtextareahandler runoutput)
    {
        try
        {
