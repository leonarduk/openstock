...
public class mcchartgenerator {
	...
	// candles do OHLC
	public java.util.List<communication.mccandle> mcg_candles;
	...
	// anotacao em hold, esta variavel contem a ultima anotacao adicionada pelo
	// usuario, que nao esta na lista de IDs
	...
	// classe que se comunica com jfreecharts para criar graficos de interesse para
	// o programa
	public mcchartgenerator() {
	}

	// <editor-fold defaultstate="collapsed" desc="Funcoes para funcionamento de
	// Anotacoes">

	// as anotacoes sao desenhos graficos criados pelos usuarios, compostos por uma
	// lista de xyannotations
	// exemplo: Line = 1 lineannotation = 1 xyannotation, Fibonacci = 6
	// linesannotations + 6 textsannotations = 12 xyannotations
	// tambem existem anotacoesfixas, que sao inseridas no grafico sem o pedido do
	// usuario
	...
	// <editor-fold defaultstate="collapsed" desc="Interpretadores de Eventos de
	// Mouse dado Anotacao Em Uso">
	...
	void interpretaranotacao_mclick(org.jfree.chart.ChartMouseEvent cmevent) {
		...
		if (anotacaoselecionada.equals("selection")) {
			// no modo de selecao nao eh necessario fazer nada, soh resetar quaisquer
			// ferramentas em uso
			...
			// no modo de reta o usuario clica a primeira vez para dar o primeiro ponto da
			// reta, e uma segunda vez para dar o segundo ponto
	...
	public java.util.List<org.jfree.chart.annotations.XYAnnotation> adicionarplotohlc_anotacaotext(double x, double y) {
		org.jfree.chart.plot.XYPlot plot = mcg_chart.getXYPlot();
		org.jfree.chart.annotations.XYTextAnnotation tatexto = new org.jfree.chart.annotations.XYTextAnnotation(
				"New Annotation", x, y);
	...
	java.util.List<org.jfree.chart.annotations.XYAnnotation> reta_preview; // reta que fica sendo redesenhada para
																			// preview e no fim eh salva com segundo
																			// clique
	...
	void executaranotacao_line_mmove(org.jfree.chart.ChartMouseEvent cmevent) {
		...
		// no caso de reta move, nos queremos que a annotation apareca constantemente
		// como preview ateh o usuario dar o segundo clique
		if (reta_jatemponto1 == false) {
			...
			try {
				...
				for (int i = 0; i < reta_preview.size(); i++) {
					plotatual.removeAnnotation(reta_preview.get(i));
				}
			} catch (Exception ex) {
			}
	...
	public java.util.List<org.jfree.chart.annotations.XYAnnotation> adicionarplotohlc_anotacaoline(double x1, double y1,
			double x2, double y2) {
		org.jfree.chart.plot.XYPlot plot = mcg_chart.getXYPlot();
		org.jfree.chart.annotations.XYLineAnnotation xylineannotation = new org.jfree.chart.annotations.XYLineAnnotation(
				x1, y1, x2, y2, new BasicStroke(1.0f), Color.red);
		...
		if (regua_jatemponto1 == false) {
			...
			try {
				...
				for (int i = 0; i < regua_preview.size(); i++) {
					plotatual.removeAnnotation(regua_preview.get(i));
				}
			} catch (Exception ex) {
			}
	...
	public java.util.List<org.jfree.chart.annotations.XYAnnotation> adicionarplotohlc_anotacaoruler(double x1,
			double y1, double x2, double y2) {
		// funcao para desenhar uma linha temporaria mostrando a diferenca de
		// porcentagem e tempo entre dois niveis
		// A
		// \
		// \
		// \
		...
		org.jfree.chart.annotations.XYLineAnnotation xyladiagonal = new org.jfree.chart.annotations.XYLineAnnotation(
				x1_diagonal, y1_diagonal, x2_diagonal, y2_diagonal, new BasicStroke(1.0f), Color.blue);
		...
		org.jfree.chart.annotations.XYTextAnnotation tatextodata = new org.jfree.chart.annotations.XYTextAnnotation(
				textodata, x1, y1);
		tatextodata.setTextAnchor(TextAnchor.TOP_LEFT);

		// texto porcentagem
		String textoporcentagem = String.format("%.2f", (y2 - y1)) + " ("
				+ String.format("%.2f", ((y2 - y1) / y1) * 100) + "%)";
		org.jfree.chart.annotations.XYTextAnnotation tatextoporcentagem = new org.jfree.chart.annotations.XYTextAnnotation(
				textoporcentagem, x2, y2);
	...
	java.util.List<org.jfree.chart.annotations.XYAnnotation> fib_preview; // o retracement de fibonacci se refere a um
																			// conjunto de linhas que sera desenhado
	...
	public java.util.List<org.jfree.chart.annotations.XYAnnotation> adicionarplotohlc_anotacaofibonacci(double x1,
			double y1, double x2, double y2) {
		...
		// o usuario comeca com o ponto (x1,y1) que se refere a altura 0% do retracement
		// e "x" de largura
		// as outras porcentagens cujas linhas devem ser desenhadas sao 23.6%, 38.2%,
		// 50.0%, 61.8% e 100%
		org.jfree.chart.plot.XYPlot plot = mcg_chart.getXYPlot();
		...
		double y2_0 = y1_0;
		org.jfree.chart.annotations.XYLineAnnotation xylalinha0 = new org.jfree.chart.annotations.XYLineAnnotation(x1_0,
				y1_0, x2_0, y2_0, new BasicStroke(1.0f), Color.black);
		org.jfree.chart.annotations.XYTextAnnotation tatexto0 = new org.jfree.chart.annotations.XYTextAnnotation("0%",
				x1, y1_0);
		...
		org.jfree.chart.annotations.XYLineAnnotation xylalinha236 = new org.jfree.chart.annotations.XYLineAnnotation(
				x1_236, y1_236, x2_236, y2_236, new BasicStroke(1.0f), Color.gray);
		org.jfree.chart.annotations.XYTextAnnotation tatexto236 = new org.jfree.chart.annotations.XYTextAnnotation(
				"23.6%", x1, y1_236);
		...
		org.jfree.chart.annotations.XYLineAnnotation xylalinha382 = new org.jfree.chart.annotations.XYLineAnnotation(
				x1_382, y1_382, x2_382, y2_382, new BasicStroke(1.0f), Color.gray);
		org.jfree.chart.annotations.XYTextAnnotation tatexto382 = new org.jfree.chart.annotations.XYTextAnnotation(
				"38.2%", x1, y1_382);
		...
		org.jfree.chart.annotations.XYLineAnnotation xylalinha500 = new org.jfree.chart.annotations.XYLineAnnotation(
				x1_500, y1_500, x2_500, y2_500, new BasicStroke(1.0f), Color.black);
		org.jfree.chart.annotations.XYTextAnnotation tatexto500 = new org.jfree.chart.annotations.XYTextAnnotation(
				"50.0%", x1, y1_500);
		...
		org.jfree.chart.annotations.XYLineAnnotation xylalinha618 = new org.jfree.chart.annotations.XYLineAnnotation(
				x1_618, y1_618, x2_618, y2_618, new BasicStroke(1.0f), Color.gray);
		org.jfree.chart.annotations.XYTextAnnotation tatexto618 = new org.jfree.chart.annotations.XYTextAnnotation(
				"61.8%", x1, y1_618);
		tatexto618.setTextAnchor(TextAnchor.CENTER_RIGHT);

		// linha paralela ao eixo x, e esta altura se refere a maxima atribuida pelo
		// usuario, ou seja a altura y2
		double x1_10000 = x1;
		double x2_10000 = x2;
		double y1_10000 = (((y2 - y1) * 1.000) + y1);
		double y2_10000 = y1_10000;
		org.jfree.chart.annotations.XYLineAnnotation xylalinha10000 = new org.jfree.chart.annotations.XYLineAnnotation(
				x1_10000, y1_10000, x2_10000, y2_10000, new BasicStroke(1.0f), Color.black);
		org.jfree.chart.annotations.XYTextAnnotation tatexto10000 = new org.jfree.chart.annotations.XYTextAnnotation(
				"100%", x1, y1_10000);
	...
	// <editor-fold defaultstate="collapsed" desc="Funcionamento Core - Crosshair
	// (Anotacao Fixa)">
	...
	void executaranotacaofixa_crosshair_mmove(org.jfree.chart.ChartMouseEvent cmevent) {
		try {
			...
			for (int i = 0; i < crosshair_preview.size(); i++) {
				plotatual.removeAnnotation(crosshair_preview.get(i));
			}
		} catch (Exception ex) {
		}
	...
	public java.util.List<org.jfree.chart.annotations.XYAnnotation> adicionarplotohlc_anotacaofixacrosshair() {
		// funcao para desenhar um crosshair, canto esq-a-dir e canto inf-a-sup no ponto
		// x e y do mouse
		/*
		 * (LV_p1) | | | (LH_p1)-----------X----(LH_p2) ~LH~ | | (LV_p2)~LV~
		 */
		...
		org.jfree.chart.annotations.XYLineAnnotation xylh = new org.jfree.chart.annotations.XYLineAnnotation(lh_p1_x,
				lh_p1_y, lh_p2_x, lh_p2_y, new BasicStroke(0.4f), Color.RED);
		...
		org.jfree.chart.annotations.XYLineAnnotation xylv = new org.jfree.chart.annotations.XYLineAnnotation(lv_p1_x,
				lv_p1_y, lv_p2_x, lv_p2_y, new BasicStroke(0.4f), Color.RED);

		// texto preco
		String textopreco = String.format("%.4f", mcg_posmousey);
		org.jfree.chart.annotations.XYTextAnnotation xytextopreco = new org.jfree.chart.annotations.XYTextAnnotation(
		...
		org.jfree.chart.annotations.XYTextAnnotation xytextodata = new org.jfree.chart.annotations.XYTextAnnotation(
	...
	// funcao para adicionar ids referentes a subannotations de uma ferramenta na
	// lista de controle
	public void adicionarplotohlc_anotacaoid(String idadicionar,
			java.util.List<org.jfree.chart.annotations.XYAnnotation> anotacao) {
		// esta funcao eh necessaria para adicionar o novo id a lista de anotacoes
		// atuais
		// essa adicao deve ser feita manualmente pela logica do core de ferramentas,
		// que funcionam com o mouse
	...
	// funcao para adicionar subannotations de uma ferramenta (utilizado ao realizar
	// load de um asset)
	public void adicionarplotohlc_anotacao(java.util.List<org.jfree.chart.annotations.XYAnnotation> anotacao) {
		...
		java.util.List<org.jfree.chart.annotations.XYAnnotation> anotacoesadicionar = anotacao;
//		org.jfree.chart.plot.XYPlot plotatual = (org.jfree.chart.plot.XYPlot) mcg_chart.getPlot();
	...
	public void adicionarplotohlc_indicador(Object xvalues, Object yvalues, String tituloscript) {
		...
		for (int i = 0; i < yvalues_double.length; i++) {
			...
			org.jfree.data.time.Millisecond millisegundoatual = new org.jfree.data.time.Millisecond(xvalues_date[i]);
	...
	public void removerplotohlc_indicador(String idindicador) {
		...
		for (int i = 0; i < mcg_indicadoresIDS.size(); i++) {
			String idindicadoratual = mcg_indicadoresIDS.get(i);
	...
	// <editor-fold defaultstate="collapsed" desc="Funcoes para recriar e retornar
	// chart OHLC com indicadores">

	public void carregarohlc(java.util.List<communication.mccandle> catual, String tituloohlc, String tipoescala,
			boolean resetaranotacoesindicadores) {
		...
		// <editor-fold defaultstate="collapsed" desc="associar miercandles novas a este
		// MCG">
		mcg_candles = catual;
		// </editor-fold>

		// <editor-fold defaultstate="collapsed" desc="criar ohlcdataset com
		// miercandles">
		org.jfree.data.xy.OHLCDataset olhcdataset = criarohlcdataset(mcg_candles, tituloohlc);
		// </editor-fold>

		// <editor-fold defaultstate="collapsed" desc="associar ohlcdataset a um novo
		// jfreechart">
		// caso grafico linear
		...
		if (tipoescala.equals("linear")) {
			...
			org.jfree.data.xy.XYDataset dataset = olhcdataset;
			org.jfree.chart.plot.XYPlot mainPlot = new org.jfree.chart.plot.XYPlot(dataset, domainAxis, rangeAxis,
					renderer);
			renderer.setSeriesPaint(0, Color.BLACK);
			renderer.setDrawVolume(true);
			rangeAxis.setAutoRangeIncludesZero(false);
			org.jfree.chart.JFreeChart chart = new org.jfree.chart.JFreeChart(tituloohlc.toUpperCase(), null, mainPlot,
					false);
			mcg_chart = chart;
		}
		// caso grafico log
		...
		// <editor-fold defaultstate="collapsed" desc="associar jfreechart a um novo
		// chartpanel">
	...
	org.jfree.data.xy.OHLCDataset criarohlcdataset(java.util.List<communication.mccandle> candles, String tituloohlc) {
		...
		for (int i = 0; i < candles.size(); i++) {
			...
			org.jfree.data.xy.OHLCDataItem dataitemadd = new org.jfree.data.xy.OHLCDataItem(candleatual.timestampdate,
					candleatual.opend, candleatual.highd, candleatual.lowd, candleatual.closed, candleatual.volumed);
		...
		org.jfree.data.xy.OHLCDataset datasetretornar = new org.jfree.data.xy.DefaultOHLCDataset(tituloohlc,
				arrayohlcitems);
