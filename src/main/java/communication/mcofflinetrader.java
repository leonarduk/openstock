...
public class mcofflinetrader
{
    ...
    assetparser.submoduloofflinetrader.panel_submoduloofflinetrader submodulooftraderpai;
    options.editorbearcodetraderbot.frame_editorbearcodetraderbot editorbctraderbotpai;
    ...
    public java.util.List<communication.mcofflinetransaction> transacoes; //lista de transacoes feitar por este trader
    
    //construtores
    //quando associado a um submoduloofflinetrader
    public mcofflinetrader(assetparser.submoduloofflinetrader.panel_submoduloofflinetrader sopai)
    {
        submodulooftraderpai = sopai;
        tipopai = "submoduloofflinetrader";
    }
    //quando associado a um editor
    public mcofflinetrader(options.editorbearcodetraderbot.frame_editorbearcodetraderbot epai)
    {
    ...
    public String realizardeposito_base(double valordeposito)
    {
        ...
        if (valordeposito > 0)
        {
            ...
            communication.mcofflinetransaction novatransacao = new
                communication.mcofflinetransaction
                (
