...
public class frame_editorbearcodeindicador extends javax.swing.JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6307824328118607538L;
	...
	// indicador)
	communication.mcbcindicatorinterpreter mcbcindicador;
	...
	public frame_editorbearcodeindicador(main.frame_telaprincipal tppai) throws IOException {
		initComponents();

		telappai = tppai;
		mcbcindicador = new communication.mcbcindicatorinterpreter("testbcindicator", "Teste Indicator", "", "");
	...
	void testarscriptindicador() {
		...
		// mbcodeinterpreter = new mierclasses.mcbcindicatorinterpreter(idbci, nomebci,
		// conteudoscriptbci, parametrosbearcode,this);
		...
		options.editorbearcodeindicador.frame_resultadosbearcodeindicador frbci = new options.editorbearcodeindicador.frame_resultadosbearcodeindicador(
				mcbcindicador);
		frbci.setVisible(true);
	}
	...
	private void initComponents() {
		...
		jPanelPaiLayout.setHorizontalGroup(jPanelPaiLayout
				...
				.addGroup(jPanelPaiLayout.createSequentialGroup().addContainerGap()
						.addGroup(jPanelPaiLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								...
								.addGroup(jPanelPaiLayout.createSequentialGroup().addComponent(jLabelTestParameters)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
										.addComponent(jTextFieldParameters)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
										.addComponent(
												jButtonTestRun, javax.swing.GroupLayout.PREFERRED_SIZE, 80,
		...
		jPanelPaiLayout.setVerticalGroup(jPanelPaiLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanelPaiLayout.createSequentialGroup().addContainerGap().addComponent(jLabelScript)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(jPanelEditorHolder, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanelPaiLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jButtonTestRun).addComponent(jLabelTestParameters)
								.addComponent(jTextFieldParameters, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
						.addGap(12, 12, 12).addComponent(jLabelOutput)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(frame_editorbearcodeindicador.class.getName())
