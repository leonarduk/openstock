...
public class frame_resultadosbearcodetraderbot extends javax.swing.JFrame
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6473152303842918411L;
    ...
    void exportardadoscsv()
    {
        try
        {
            ...
            if (userSelection == javax.swing.JFileChooser.APPROVE_OPTION) 
            {
                ...
                writer.close();
                communication.mcfuncoeshelper.mostrarmensagem(".csv simulation results exported.");
            }
            
        }
        catch (Exception ex)
        {
            communication.mcfuncoeshelper.mostrarmensagem("A problem occurred when exporting. Exception: " + ex.getMessage());
        }
    }
