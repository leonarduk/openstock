...
public class frame_editorbearcodetraderbot extends javax.swing.JFrame {
	...
	void inicializar() throws IOException {
		...
		mcbctraderbot = new communication.mcbctradingbotinterpreter("testbctraderbot", "Teste Trader Bot", "", "");
		// adicionar handler para print de output pelo script
		mcjtah = new communication.mcjtextareahandler(jTextAreaOutput);
	...
	void atualizardadoscandlessimulador() throws IOException {
		...
		if (candlessample == null) {
			...
			jLabelCandlesDataStatus.setText(
					"Current Data: " + sourcesimboloescolhido.toUpperCase() + " (size: " + candlessample.size() + ")");
			...
			for (int i = 1; i < candlessample.size(); i++) {
				...
				communication.mccandle candleatual = candlessample.get(i);

				String dataadicionar = (candleatual.timestampdate.getMonth() + 1) + "/"
						+ candleatual.timestampdate.getDate() + "/" + (candleatual.timestampdate.getYear() + 1900) + " "
						+ candleatual.timestampdate.getHours() + ":" + candleatual.timestampdate.getMinutes() + ":"
	...
	void rodarsimulacao() {
		...
		for (int i = 0; i < numero_de_simulacoes; i++) {
			...
			// rodar script
			String result = mcbctraderbot.rodarscript(candlessimulacao, otrader.quantidademoedabase,
					otrader.quantidademoedacotacao, otrader.melhorbid, otrader.melhorask, otrader.feecompra,
					otrader.feevenda, true, mcjtah);
			...
			if (result.equals("ok")) {
				...
				if (jCheckBoxAutoTrade.isSelected() == true) {
					...
					String traderbot_supportamount = String
							.valueOf(((double[]) mcbctraderbot.respostaquantidadesuporte_lastrun)[0]);
			...
			String traderbot_supportamount = String
					.valueOf(((double[]) mcbctraderbot.respostaquantidadesuporte_lastrun)[0]);
			String traderbot_debugexport = (String) mcbctraderbot.debugexport_lastrun; // variavel de suporte para print
	...
	String retornartimestampcsv(java.util.Date timestampDate) {
		String timestampstring = (timestampDate.getYear() + 1900) + "-" + (timestampDate.getMonth() + 1) + "-"
	...
	void salvararquivobcodeedicao() {
		try {
			...
			javax.swing.filechooser.FileFilter filter = new communication.mcextensionfilefilter("Bearcode File",
					new String[] { "bearcode" });
		...
		try {
			...
			if (userSelection == javax.swing.JFileChooser.APPROVE_OPTION) {
				...
				try {
					...
					String scripttexto = communication.mcfuncoeshelper
	...
	private void initComponents() {
		...
		javax.swing.GroupLayout jPanelChooseDataSimulatorLayout = new javax.swing.GroupLayout(
				jPanelChooseDataSimulator);
		jPanelChooseDataSimulator.setLayout(jPanelChooseDataSimulatorLayout);
		jPanelChooseDataSimulatorLayout
				.setHorizontalGroup(
						jPanelChooseDataSimulatorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelChooseDataSimulatorLayout
										.createSequentialGroup().addContainerGap().addComponent(jLabelNomeSimbolo)
										...
										.addComponent(jLabelCandlesDataStatus).addContainerGap()));
		jPanelChooseDataSimulatorLayout.setVerticalGroup(jPanelChooseDataSimulatorLayout
				...
				.addGroup(jPanelChooseDataSimulatorLayout.createSequentialGroup().addContainerGap()
						.addGroup(jPanelChooseDataSimulatorLayout
								...
								.addComponent(jComboBoxPeriodoSimbolo, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jLabelCandlesDataStatus).addComponent(jButtonRecarregarCandlesData))
		...
		jPanelPaiLayout.setHorizontalGroup(jPanelPaiLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addComponent(jPanelChooseDataSimulator, javax.swing.GroupLayout.DEFAULT_SIZE,
						javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
				.addGroup(jPanelPaiLayout.createSequentialGroup().addContainerGap()
						.addGroup(jPanelPaiLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								...
								.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
										jPanelPaiLayout.createSequentialGroup().addComponent(jButtonResetEditor)
												.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
														javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								...
								.addGroup(
										...
										jPanelPaiLayout
												.createSequentialGroup().addComponent(jLabelParameters)
								...
								.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelPaiLayout
										...
										.addGroup(jPanelPaiLayout
												.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
												.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelPaiLayout
														.createSequentialGroup().addComponent(jLabelBuyFee1)
														.addPreferredGap(
																javax.swing.LayoutStyle.ComponentPlacement.RELATED)
														.addComponent(jComboBoxMinInterval,
																javax.swing.GroupLayout.PREFERRED_SIZE, 150,
																javax.swing.GroupLayout.PREFERRED_SIZE)
														.addPreferredGap(
																javax.swing.LayoutStyle.ComponentPlacement.RELATED)
														.addComponent(jComboBoxMaxInterval,
												...
												.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelPaiLayout
														.createSequentialGroup().addComponent(jLabelBuyFee)
														.addPreferredGap(
																javax.swing.LayoutStyle.ComponentPlacement.RELATED)
														.addComponent(jTextFieldBuyFee,
																javax.swing.GroupLayout.PREFERRED_SIZE, 63,
																javax.swing.GroupLayout.PREFERRED_SIZE)
														.addGap(12, 12, 12).addComponent(jLabelSellFee)
														.addPreferredGap(
																javax.swing.LayoutStyle.ComponentPlacement.RELATED)
														.addComponent(jTextFieldSellFee,
																javax.swing.GroupLayout.PREFERRED_SIZE, 63,
																javax.swing.GroupLayout.PREFERRED_SIZE)
														.addPreferredGap(
																javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
														...
														.addPreferredGap(
																javax.swing.LayoutStyle.ComponentPlacement.RELATED)
														.addComponent(jTextFieldBaseAmount,
														...
														.addPreferredGap(
																javax.swing.LayoutStyle.ComponentPlacement.RELATED)
														.addComponent(jTextFieldQuoteAmount,
																javax.swing.GroupLayout.PREFERRED_SIZE, 110,
																javax.swing.GroupLayout.PREFERRED_SIZE))))
								.addGroup(jPanelPaiLayout.createSequentialGroup()
										.addGroup(jPanelPaiLayout
												.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
												.addComponent(jLabelScript).addComponent(jLabelOutput))
										.addGap(0, 0, Short.MAX_VALUE))
								.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
										jPanelPaiLayout.createSequentialGroup()
												.addComponent(jPanelEditorHolder, javax.swing.GroupLayout.DEFAULT_SIZE,
														javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
		...
		jPanelPaiLayout.setVerticalGroup(jPanelPaiLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanelPaiLayout.createSequentialGroup()
						.addComponent(jPanelChooseDataSimulator, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(jLabelScript)
						.addGroup(jPanelPaiLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						...
						.addGroup(jPanelPaiLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								...
								.addComponent(jTextFieldParameters, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
						.addGap(8, 8, 8)
						.addGroup(jPanelPaiLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabelBuyFee).addComponent(jLabelSellFee)
								.addComponent(jTextFieldSellFee, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jTextFieldBuyFee, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jTextFieldBaseAmount, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jLabelBaseAmount)
								.addComponent(jTextFieldQuoteAmount, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jLabelQuoteAmount))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanelPaiLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jButtonRun).addComponent(jCheckBoxAutoTrade)
								.addComponent(jComboBoxMinInterval, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jComboBoxMaxInterval, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jLabelBuyFee1))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addComponent(jLabelOutput).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 121,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanelPaiLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jButtonSaveFile).addComponent(jButtonLoadFile)
		...
		layout.setHorizontalGroup(
				layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jPanelPai,
