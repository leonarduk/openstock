...
public class frame_outrasopcoes extends javax.swing.JFrame {
	...
	private void jButtonOpenBearcodeIndicatorEditorActionPerformed(java.awt.event.ActionEvent evt) throws IOException {// GEN-FIRST:event_jButtonOpenBearcodeIndicatorEditorActionPerformed
		...
		outrasopcoes.editorbearcodeindicador.frame_editorbearcodeindicador mfebc = new outrasopcoes.editorbearcodeindicador.frame_editorbearcodeindicador(
				telappai);
		mfebc.show();
	...
	{// GEN-HEADEREND:event_jButtonOpenBearcodeBotEditorActionPerformed
		outrasopcoes.editorbearcodetraderbot.frame_editorbearcodetraderbot mfebc = new outrasopcoes.editorbearcodetraderbot.frame_editorbearcodetraderbot(
				telappai);
		mfebc.show();
