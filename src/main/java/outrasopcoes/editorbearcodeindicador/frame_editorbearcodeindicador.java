...
public class frame_editorbearcodeindicador extends javax.swing.JFrame {
	...
	void testarscriptindicador() {
		...
		outrasopcoes.editorbearcodeindicador.frame_resultadosbearcodeindicador frbci = new outrasopcoes.editorbearcodeindicador.frame_resultadosbearcodeindicador(
				mcbcindicador);
		frbci.show();
	}
